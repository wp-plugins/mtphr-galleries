...
function mtphr_gallery_settings_render_metabox() {
	...
	$rotate_speed = intval( get_post_meta( $post->ID, '_mtphr_gallery_slider_speed', true ) );
	...
	echo '<div id="mtphr-galleries-page-tabs">';
  	echo '<ul>';
    	...
    	echo '<li class="nav-tab"><a href="#mtphr-galleries-page-tabs-1">'.__('Resources', 'mtphr-galleries').'</a></li>';
			echo '<li class="nav-tab"><a href="#mtphr-galleries-page-tabs-2">'.__('Rotator Settings', 'mtphr-galleries').'</a></li>';
			echo '<li class="nav-tab"><a href="#mtphr-galleries-page-tabs-3">'.sprintf(__('%s Data', 'mtphr-galleries'), $settings['singular_label']).'</a></li>';
		...
		echo '<div id="mtphr-galleries-page-tabs-1" class="mtphr-galleries-page-tabs-page">';
			...
			echo '<a href="#" id="mtphr-galleries-add-images" class="button-primary">'.__('Add Images', 'mtphr-galleries').'</a>';
			echo '<table id="mtphr-galleries-thumbnails">';
				echo '<tr class="clearfix">';
					if( is_array($resources) && count($resources) > 0 ) {
						foreach( $resources as $i=>$id ) {
							mtphr_gallery_render_thumb( $id );
						}
					}
				echo '</tr>';
			echo '</table>';
...
function mtphr_gallery_render_thumb( $id ) {
  ...
  echo '<td class="mtphr-gallery-thumbnail">';
		...
		echo $thumb;
		echo '<a class="mtphr-gallery-image-delete href="#"></a>';
	echo '</td>';
}
